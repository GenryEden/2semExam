...
// На вход функции подается одномерный массив строк, которые содержат фамилии, имена и отчества первокурсников.
// Размер массива не более 500 элементов
// Необходимо, чтобы функция разбивала всех первокурсников на подмножества по принципу -
// - все студенты с одинаковыми инициалами помещаются в одно подмножество
